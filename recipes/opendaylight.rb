...
#Download zip file 
remote_file "#{Chef::Config[:file_cache_path]}/distributions-virtualization-0.1.1-osgipackage.zip" do
...
bash 'extract_odl' do
  cwd "/usr/share"
  code <<-EOH
      unzip #{Chef::Config[:file_cache_path]}/distributions-virtualization-0.1.1-osgipackage.zip
    EOH
